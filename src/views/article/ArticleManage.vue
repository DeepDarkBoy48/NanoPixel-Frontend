...
<template>
    <el-card class="page-container">
        ...
        <el-table :data="articles" style="width: 100%">
            <el-table-column label="序号" width="100" prop="id" v-if="false"> </el-table-column>
        ...
        <!-- 抽屉 -->
        <el-drawer v-model="visibleDrawer" :title="title" direction="rtl" size="50%" @close="resetForm">
            <!-- 添加文章表单 -->
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item>
                    ...
                    <el-button type="info" @click="addArticle('草稿')" v-show="title == '添加文章'">草稿</el-button>
                </el-form-item>
            </el-form>
        </el-drawer>
    </el-card>
