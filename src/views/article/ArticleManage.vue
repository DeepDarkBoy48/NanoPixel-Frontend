...
const uploadSuccess = (result) => {
  articleModel.value.coverImg = result.data.fileUrl;
...
<template>
  <el-card class="page-container">
    <template #header>
      <div class="header">
        ...
        <div class="extra">
          <el-button
            type="primary"
            @click="(title = '添加文章'), (visibleDrawer = true)"
            >添加文章</el-button
          >
        </div>
      </div>
    ...
    <el-table :data="articles" style="width: 100%">
      <el-table-column label="序号" width="100" prop="id" v-if="false">
      </el-table-column>
      <el-table-column
        label="文章标题"
        width="400"
      ...
      <el-form :model="articleModel" label-width="100px">
        ...
        <el-form-item>
          <el-button
            type="primary"
            @click="
              title == '添加文章' ? addArticle('已发布') : updateArticle()
            "
            >发布</el-button
          >
          <el-button
